...
It was the worst of times.
    ...
    assert_equal 54, long_string.size # begins with a newline character
  end 
...
It was the worst of times.
EOS
    assert_equal 53, long_string.size # no newline character?
  end
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # 
    # Not sure, that's a surprising side-effect
  end
  ...
  def test_any_ruby_expression_may_be_interpolated
    ...
    # I think changing this from 5 to 4 is a better test of interpolation
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    string = "Bacon, lettuce and tomato"
    assert_equal "a"[0], string[1]

    # Surprised?
    # Yes, which is probaby why they changed it in ruby 1.9 to return "a" instead of 97
  end
